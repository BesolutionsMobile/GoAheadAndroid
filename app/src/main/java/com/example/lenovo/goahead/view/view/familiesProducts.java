...
public class familiesProducts extends AppCompatActivity implements productsMvp.interfaces.View, userData.interfaces.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_families_products);
        intent=getIntent();
        ...
        category.setText("Store "+Name);
        FamiliesproductsList=(RecyclerView)findViewById(R.id.FamiliesproductsList);
        productsPresenter=new productsPresenter(this,this,FamiliesproductsList,category_id,seller_id);
        ...
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET, categoriesUrl, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    Toast.makeText(familiesProducts.this, ""+e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();                    }

            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(familiesProducts.this, "error", Toast.LENGTH_SHORT).show();
            }

        });
        RequestQueue requestQueue= Volley.newRequestQueue(familiesProducts.this);
    ...
    public void LOGOUT()
    {
        ...
        Logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressdialog.progressDialog(familiesProducts.this);
                startActivity(new Intent(familiesProducts.this,login.class));
            }
        });
    }
    ...
    public void getNavigationData(ArrayList data)
    {
        ...
        addnewproducts.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(familiesProducts.this,addNewProduct.class));
            }
        });

        RecyclerView    navLists=(RecyclerView)findViewById(R.id.navlist);
        RecyclerView.LayoutManager   navLayoutManager=new LinearLayoutManager(familiesProducts.this);
        navLists.setLayoutManager(navLayoutManager);
        RecyclerView.Adapter navCategoriesAdapter=new navigationAdapter(familiesProducts.this,data);
...
//menu button
    ...
    public void goToActivity()
    {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                {
                    startActivity(new Intent(familiesProducts.this,favourite.class));
                }else if(menuItem.getItemId()==R.id.mistadded)
                {
                    startActivity(new Intent(familiesProducts.this,mostAdded.class));

                }else if(menuItem.getItemId()==R.id.Familiesproduced)
                {
                    startActivity(new Intent(familiesProducts.this,familiesProduces.class));
                }
                else if(menuItem.getItemId()==R.id.offers)
                {
                    startActivity(new Intent(familiesProducts.this,offers.class));
    ...
    private void getDetails()
    {
        ...
        userPresenter userPresenter=new userPresenter(familiesProducts.this,familiesProducts.this,name,profile);
    ...
    private void onClickNav()
    {
        ...
        myProducts.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(familiesProducts.this,myProducts.class));
