...
public class offers extends AppCompatActivity implements userData.interfaces.View{
    ...
    public static final String favUrl="http://coderg.org/goahead_en/Category/viewSpecialOffers/82984218/951735/";
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (response.getString("status").equals("1")){
                        ...
                        GridLayoutManager layoutManager = new GridLayoutManager(offers.this, 2);
                        ...
                        favAdapter=new catAdapter(500,offers.this,arrayList);
                        favouriteList.setAdapter(favAdapter);
                    }
                    else if(response.getString("status").equals("2"))
                    {
                        Toast.makeText(offers.this, response.getString("message"), Toast.LENGTH_SHORT).show();
                    }
                    ...
                    Toast.makeText(offers.this, "someThing wrong", Toast.LENGTH_SHORT).show();                }
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(offers.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
            }
        }
        );
        ...
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET, categoriesUrl, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    Toast.makeText(offers.this, "catch", Toast.LENGTH_SHORT).show();                    }
    ...
    public void getNavigationData(ArrayList data)
    {
        ...
        navLayoutManager=new LinearLayoutManager(offers.this);
        navLists.setLayoutManager(navLayoutManager);
        navCategoriesAdapter=new navigationAdapter(offers.this,data);
    ...
    public void LOGOUT()
    {
        ...
        Logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendBoolean();
                progressdialog.progressDialog(offers.this);
    ...
    public void addNewProduct()
    {
        ...
        addnewproducts.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(offers.this,addNewProduct.class));
            }
        });
    }
    ...
    public void goToActivity()
    {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                {
                    startActivity(new Intent(offers.this,favourite.class));
                }else if(menuItem.getItemId()==R.id.mistadded)
                {
                    startActivity(new Intent(offers.this,mostAdded.class));

                }else if(menuItem.getItemId()==R.id.Familiesproduced)
                {
                    startActivity(new Intent(offers.this,familiesProduces.class));
                }
    ...
    private void getDetails()
    {
        ...
        userPresenter userPresenter=new userPresenter(offers.this,offers.this,name,profile);
    ...
    private void onClickNav()
    {
        ...
        myProducts.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(offers.this,myProducts.class));
